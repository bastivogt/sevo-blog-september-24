"""
Django settings for sevo_blog project.
...
SECRET_KEY = 'django-insecure-0#ywhy4ek-siod#gt^95*-6h-&@@y3%rkgpb%#h2_k_8zgr-q^'
...
WSGI_APPLICATION = 'sevo_blog.wsgi.application'
